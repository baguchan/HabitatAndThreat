...
public class ModModelLayers {
	...
	public static final ModelLayerLocation WILDFIRE_SHIELD = new ModelLayerLocation(new ResourceLocation(HabitatAndThreat.MODID, "wildfire_shield"), "wildfire_shield");
