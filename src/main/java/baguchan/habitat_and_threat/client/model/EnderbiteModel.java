package baguchan.habitat_and_threat.client.model;// Made with Blockbench 4.0.3
...
public class EnderbiteModel<T extends Enderbite> extends EntityModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		if (entity.isFlying()) {
			this.fetherR.xRot = 0.7037F - (0.35F * Mth.cos(ageInTicks * 4F));
			this.fetherL.xRot = 0.7037F - (0.35F * Mth.cos(ageInTicks * 4F));
