...
public class ModItems {
	...
	public static final RegistryObject<ForgeSpawnEggItem> ENDERBITE_SPAWN_EGG = ITEMS.register("enderbite_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.ENDERBITE, 0x3A294B, 0x4B395F, new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
