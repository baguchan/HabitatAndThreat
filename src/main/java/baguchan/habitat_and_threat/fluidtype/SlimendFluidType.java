package baguchan.habitat_and_threat.fluidtype;
...
public class SlimendFluidType extends FluidType {
	public SlimendFluidType(FluidType.Properties properties) {
		super(properties);
	}
	...
	public boolean move(FluidState state, LivingEntity entity, Vec3 movementVector, double gravity) {
		...
		if (entity.getFluidTypeHeight(this) <= entity.getFluidJumpThreshold()) {
			entity.setDeltaMovement(entity.getDeltaMovement().multiply(0.985D, (double) 0.895D, 0.985D));
			Vec3 vec33 = entity.getFluidFallingAdjustedMovement(gravity, flag, entity.getDeltaMovement());
			entity.setDeltaMovement(vec33);
		} else {
			entity.setDeltaMovement(entity.getDeltaMovement().scale(0.895D));
		}
	...
	public void initializeClient(Consumer<IFluidTypeRenderProperties> consumer) {
		consumer.accept(new IFluidTypeRenderProperties() {
			private static final ResourceLocation TEXTURE_STILL = new ResourceLocation(HabitatAndThreat.MODID, "block/slimend");
			private static final ResourceLocation TEXTURE_FLOW = new ResourceLocation(HabitatAndThreat.MODID, "block/slimend");
			private static final ResourceLocation TEXTURE_OVERLAY = new ResourceLocation(HabitatAndThreat.MODID, "textures/block/slimend_overlay.png");
